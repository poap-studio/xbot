  ...
  try {
    ...
    const project = await prisma.project.create({
      data: {
        ...
        allowMultipleClaims,
        botReplyEligible: botReplyEligible || 'Congratulations! You shared the correct code. Claim your POAP here: {{claimUrl}}',
        botReplyNotEligible: botReplyNotEligible || 'Thank you for your interest. Please make sure to include a valid code and an image in your tweet.',
